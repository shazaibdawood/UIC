	...
	public: 
        ...
        bool makeMoves(char HeroNextMove) {
            ...
            try {
                ...
                if(board(HeroRow, newC)->isBarrier()){
                    newC = HeroCol;   
                    cout << "Horizontal wall" << endl;                 
                }

                if(board(newR, HeroCol)->isBarrier()){
                    newR = HeroRow;
                    cout << "Vertical wall" << endl;                 
                }
            }
            ...
            if(board(newR, newC)->isExit()){
                ...
                HeroRow = newR;
                HeroCol = newC;
                board(HeroRow, HeroCol) = new Hero(HeroRow, HeroCol);
                onBoard = true;
            }
            findHero();
            ...
            // for(int i = 0; i < numRows; i++){
            //     for(int j = 0; j < numCols; j++){
            //         if(board(i, j)->isBaddie() && !board(i, j)->getMoved()){
            //             outC = false;
            //             outR = false;
            //             board(i, j)->attemptMoveTo(newR,newC, HeroRow, HeroCol);
            ...
            //                 if(board(i, newC)->isBarrier()){
            //                     newC = j;   
            //                     cout << "Horizontal wall" << endl;                 
            //                 }

            //                 if(board(newR, j)->isBarrier()){
            //                     newR = i;
            //                     cout << "Vertical wall" << endl;                 
            //                 }
            //             }
            ...
            //                 if(board(i, newC)->isExit()){
            //                     newC = j;   
            //                 }

            //                 if(board(newR, j)->isExit()){
            //                     newR = i;
            //                 }
            //             }
