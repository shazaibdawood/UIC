...
# User entered words will be stored in set usedWords
    ...
    if(start and (not word4 in gameboard or word4 == "" or word4 in usedWords)):
        ...
        if(not word4 in gameboard or word4 == "" or word4 in usedWords):
            ...
            usedWords.add(word4)
            category = checkSolution(solution, usedWords)
...
# Gameboard is updated if a category is found
    ...
    wordString = ": " + word1.upper() + ", " + word2.upper() + ", " + word3.upper() + ", " + word4.upper()

    answer = category.upper().strip() + wordString
    print(answer)

    print("Mistakes:", mistakes)
elif(start and category == ""):
...
# Gameboard is updated if a category is found
    ...
    if(len(answer) == 0):
        ...
        answer = answer + "\n" + category.upper().strip() + wordString
    print(answer)
